...
namespace Cmx.Timesheet.WebApi
{
    ...
    public class TimesheetAdminController : ApiController
    {
        private readonly ITimesheetStore _timesheetStore;
        private readonly ITimesheetWorkflowService _timesheetWorkflowService;

        public TimesheetAdminController(ITimesheetStore timesheetStore, ITimesheetWorkflowService timesheetWorkflowService)
        {
